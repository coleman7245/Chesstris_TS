...
class Collider {
    ...
    public constructor(size : Vector2, localPosition : Vector2, globalPosition : Vector2) {
    ...
    public copy() : Collider {return new Collider(this._size, this._local_position, this._global_position);}
